...
let RenaultSupport = {
    ...
    handleFileUpload(container) {
        // Create a hidden file input field
        ...
        fileInput.addEventListener('change', (e) => {
            ...
            // Save the file data (store in the container for now)
            container.dataset.files = JSON.stringify(files.map(file => ({
                name: file.name,
                size: file.size,
                type: file.type
            })));
